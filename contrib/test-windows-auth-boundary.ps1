# Disposable CI only. Never installs a service, changes accounts, or opens Hello.
...
$command = "& '$exeLiteral' --ignored --exact native::tests::system_created_collector_denies_owner_mutation_from_birth --nocapture *> '$logLiteral'; exit `$LASTEXITCODE"
