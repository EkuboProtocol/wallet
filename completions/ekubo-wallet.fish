...
complete -c ekubo-wallet -n '__fish_seen_subcommand_from account; and not __fish_seen_subcommand_from list create import export remove' -a 'list create import export remove'
complete -c ekubo-wallet -n '__fish_seen_subcommand_from network; and not __fish_seen_subcommand_from list presets reset add edit remove delete review' -a 'list presets reset add edit remove delete review'
complete -c ekubo-wallet -n '__fish_seen_subcommand_from network; and __fish_seen_subcommand_from presets' -l search -r -d 'Search the compiled-in registry by chain ID or name'
complete -c ekubo-wallet -n '__fish_seen_subcommand_from network; and __fish_seen_subcommand_from presets' -l all -d 'List every chain in the compiled-in registry'
...
complete -c ekubo-wallet -n '__ekubo_wallet_at_position 3; and __fish_seen_subcommand_from export remove; and __fish_seen_subcommand_from account' -a '(ekubo-wallet __complete wallets-fish 2>/dev/null)'
...
complete -c ekubo-wallet -n '__fish_seen_subcommand_from network; and __fish_seen_subcommand_from add' -l rpc-url -r -d 'RPC endpoint; repeat for fallbacks'
complete -c ekubo-wallet -n '__fish_seen_subcommand_from network; and __fish_seen_subcommand_from add' -l rpc-strategy -r -a 'ordered random m_of_n(2) m_of_n(3)' -d 'How the endpoints are used'
...
complete -c ekubo-wallet -n '__ekubo_wallet_at_position 2; and __fish_seen_subcommand_from portfolio balance' -a '(ekubo-wallet __complete wallets-fish 2>/dev/null)'
complete -c ekubo-wallet -n '__fish_seen_subcommand_from portfolio balance' -l network -r -a '(ekubo-wallet __complete networks-fish 2>/dev/null)' -d 'Network name, alias, or chain ID'
complete -c ekubo-wallet -n '__fish_seen_subcommand_from portfolio balance' -l tokens -r -d 'How many known tokens to check'
